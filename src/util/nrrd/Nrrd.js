//wrapper around nrrd-js
//2017: minor patches, gzip encoding (A. Plesch)
...
var assert = x3dom.debug.assert; // use x3dom assert
...
x3dom.nrrd.serialize = function (nrrdOrg) {
  // removed. See https://github.com/scijs/nrrd-js  
};

// This expects an ArrayBuffer.
//module.exports.parse = function (buffer) {
x3dom.nrrd.parse = function (buffer) {
...
function checkNRRD(ret) {
    ...
    if ((ret.data === undefined || (ret.data && ret.data.length === 0)) && (ret.buffer === undefined || (ret.buffer && ret.buffer.byteLength === 0)) && ret.dataFile === undefined) {
