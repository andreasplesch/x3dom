...
x3dom.registerNodeType(
    "X3DHAnimTransformNode",
    "H-Anim",
    defineClass(x3dom.nodeTypes.X3DTransformNode,
        
        /**
         * Constructor for X3DHAnimTransformNode
         * @constructs x3dom.nodeTypes.X3DHAnimTransformNode
         * @x3dom 3.3
         * @component H-Anim
         * @status experimental
         ...
         */
        function (ctx) {
            x3dom.nodeTypes.X3DHAnimTransformNode.superClass.call(this, ctx);
